...
<!-- Navbar -->
<nav class="bg-white/5 backdrop-blur-xl border-b border-white/10 px-8 py-4">
    <div class="flex justify-center mb-4">
        <img src="{{ asset('images/Groupify-removebg.png') }}" alt="Groupify Logo" class="h-60g drop-shadow-4xl">
    </div>
    <div class="flex justify-center space-x-6 font-medium">
